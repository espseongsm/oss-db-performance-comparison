...
Parsing QA: `{"pdf_pages": 54120, "empty_text_pages": 215, "unique_evidence_pages": 168, "evidence_pages_without_chunks": [], "completed_engines": ["cortex"], "failed_engines": []}`
...
- cortex: complete; results in `cortex`.

### Versions and plans

- cortex: 10.33.101; load + index 81.59s. Execution plans/settings in `cortex/metadata.json`.

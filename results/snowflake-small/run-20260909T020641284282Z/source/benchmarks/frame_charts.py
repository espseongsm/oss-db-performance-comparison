...
def render_results(folder: Path) -> None:
    ...
    if "snowflake" in manifest:
        from benchmarks.frame_snowflake_report import render_snowflake_comparison

        render_snowflake_comparison(folder, raw, summary, manifest)
